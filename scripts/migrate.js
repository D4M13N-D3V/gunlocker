  ...
  const collections = [
    {
      ...
      fields: [
        ...
        { name: 'photos', type: 'file', options: { protected: true, maxSelect: 10, maxSize: 10485760, mimeTypes: ['image/jpeg', 'image/png', 'image/webp', 'image/gif'], thumbs: ['100x100', '300x200'] } },
        { name: 'documents', type: 'file', options: { protected: true, maxSelect: 10, maxSize: 20971520, mimeTypes: ['application/pdf', 'image/jpeg', 'image/png'] } },
    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'notes', type: 'text' },
        { name: 'photos', type: 'file', options: { protected: true, maxSelect: 10, maxSize: 10485760, mimeTypes: ['image/jpeg', 'image/png', 'image/webp', 'image/gif'], thumbs: ['100x100', '200x200'] } },
        { name: 'documents', type: 'file', options: { protected: true, maxSelect: 10, maxSize: 20971520, mimeTypes: ['application/pdf', 'image/jpeg', 'image/png'] } },
        { name: 'user', type: 'relation', required: true, options: { collectionId: '_pb_users_auth_', maxSelect: 1 } },
      ],
      listRule: '@request.auth.id != "" && user = @request.auth.id',
    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'notes', type: 'text' },
        { name: 'photos', type: 'file', options: { protected: true, maxSelect: 10, maxSize: 10485760, mimeTypes: ['image/jpeg', 'image/png', 'image/webp', 'image/gif'], thumbs: ['100x100'] } },
        { name: 'user', type: 'relation', required: true, options: { collectionId: '_pb_users_auth_', maxSelect: 1 } },
      ],
      listRule: '@request.auth.id != "" && user = @request.auth.id',
      viewRule: '@request.auth.id != "" && user = @request.auth.id',
